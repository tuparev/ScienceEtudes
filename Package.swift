...
let package = Package(
    ...
    products: [
        ...
        .library(name: "AstronomyTime", targets: ["AstronomyTime"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target(name: "AstronomyTime",        dependencies: [.product(name: "SoftwareEtudesUtilities", package: "SoftwareEtudes"), "CoreMaths"], path: "Sources/Astronomy/Time"),
